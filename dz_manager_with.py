...
with open('txwt2.txt', 'w') as file:
    file.write(text)


with open('txwt2.txt', 'r') as file:
    txt = file.read()
print(txt)
...
# Контнекстный менеджер with контролирует рабту с потоком, в нашем случае с фаулом, т.е. закрывает и открывает файл
